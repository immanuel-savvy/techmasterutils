let express,cors,bodyParser,domain,remove_file,save_file,WordsApi,SaveOptionsData,SaveAsOnlineRequest,createReadStream,writeFileSync,GoogleNewRss,shuffle,routes,ds_conn,create_default_admin;_68b‍.w("express",[["default",["express"],function(v){express=v}]]);_68b‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_68b‍.w("body-parser",[["default",["bodyParser"],function(v){bodyParser=v}]]);_68b‍.w("./utils",[["domain",["domain"],function(v){domain=v}],["remove_file",["remove_file"],function(v){remove_file=v}],["save_file",["save_file"],function(v){save_file=v}]]);_68b‍.w("asposewordscloud",[["WordsApi",["WordsApi"],function(v){WordsApi=v}],["SaveOptionsData",["SaveOptionsData"],function(v){SaveOptionsData=v}],["SaveAsOnlineRequest",["SaveAsOnlineRequest"],function(v){SaveAsOnlineRequest=v}]]);_68b‍.w("fs",[["createReadStream",["createReadStream"],function(v){createReadStream=v}],["writeFileSync",["writeFileSync"],function(v){writeFileSync=v}]]);_68b‍.w("google-news-rss",[["default",["GoogleNewRss"],function(v){GoogleNewRss=v}]]);_68b‍.w("underscore",[["shuffle",["shuffle"],function(v){shuffle=v}]]);_68b‍.w("./news/routes",[["default",["routes"],function(v){routes=v}]]);_68b‍.w("./news/conn",[["default",["ds_conn"],function(v){ds_conn=v}]]);_68b‍.w("./news/handlers/starter",[["create_default_admin",["create_default_admin"],function(v){create_default_admin=v}]]);
...
process.on("uncaughtException", function (error) {
  _68b‍.g.console.log(error.stack);
});
