let remove_image,save_image,ARTICLES,ARTICLE_CATEGORIES,COMMENTS,GLOBALS,REPLIES,TRENDING_ARTICLES;_da6‍.x([["get_articles",()=>get_articles],["article",()=>article],["articles",()=>articles],["new_article",()=>new_article],["remove_article",()=>remove_article],["update_article",()=>update_article],["article_categories",()=>article_categories],["add_article_category",()=>add_article_category],["remove_article_category",()=>remove_article_category],["update_article_category",()=>update_article_category],["new_comment",()=>new_comment],["comments",()=>comments],["get_replies",()=>get_replies],["article_viewed",()=>article_viewed],["new_reply",()=>new_reply],["trending_articles",()=>trending_articles],["remove_trending_article",()=>remove_trending_article],["search_articles",()=>search_articles],["GLOBAL_trending_articles",()=>GLOBAL_trending_articles]]);_da6‍.w("../../utils",[["remove_image",["remove_image"],function(v){remove_image=v}],["save_image",["save_image"],function(v){save_image=v}]]);_da6‍.w("../conn",[["ARTICLES",["ARTICLES"],function(v){ARTICLES=v}],["ARTICLE_CATEGORIES",["ARTICLE_CATEGORIES"],function(v){ARTICLE_CATEGORIES=v}],["COMMENTS",["COMMENTS"],function(v){COMMENTS=v}],["GLOBALS",["GLOBALS"],function(v){GLOBALS=v}],["REPLIES",["REPLIES"],function(v){REPLIES=v}],["TRENDING_ARTICLES",["TRENDING_ARTICLES"],function(v){TRENDING_ARTICLES=v}]]);
