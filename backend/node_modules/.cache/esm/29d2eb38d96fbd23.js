let USERS,USERS_HASH,nodemailer,generate_random_string;_d96‍.x([["signup",()=>signup],["login",()=>login],["user_by_email",()=>user_by_email],["user",()=>user],["send_mail",()=>send_mail],["verify_email",()=>verify_email],["to_title",()=>to_title],["update_user",()=>update_user]]);_d96‍.w("../conn",[["USERS",["USERS"],function(v){USERS=v}],["USERS_HASH",["USERS_HASH"],function(v){USERS_HASH=v}]]);_d96‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_d96‍.w("generalised-datastore/utils/functions",[["generate_random_string",["generate_random_string"],function(v){generate_random_string=v}]]);
...
const send_mail = ({
  ...
  try {
    ...
    _d96‍.g.console.log("in here with", recipient);
  } catch (e) {}
  ...
  try {
    transporter
      ...
      .then(() => {})
      .catch((e) => _d96‍.g.console.log(e));
    _d96‍.g.console.log("Email sent", recipient);
  } catch (e) {}
};
