...
export declare const importsMapStructuredDocumentTagListItem: {};
/**
 * DTO container with a SdtListItem for StructuredDocumentTag.
 */
export declare class StructuredDocumentTagListItem implements ModelInterface {
    /**
     * Attribute type map
     */
     ...
     */
    value: string;
    constructor(init?: Partial<StructuredDocumentTagListItem>);
