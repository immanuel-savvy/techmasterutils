            ...
            <section className="section">
              ...
              <div className="content" style={{ marginTop: 40 }}>
                <form action="">
                  ...
                  <input
                    name=""
                    value={
                      loan_amount ? commalise_figures(Number(loan_amount)) : ""
                    }
                    placeholder=""
                    onChange={({ target }) =>
                      this.setState({
                  ...
                  <input
                    ...
                    value={
                      annual_income
                        ? commalise_figures(Number(annual_income))
                        : ""
                    }
                    placeholder=""
                    onChange={({ target }) =>
              ...
              <div className="content">
                ...
                >
                  ...
                  substitute for conducting your research and consulting
                  official sources, such as the UK Government website. Keep in
                  mind that this tool makes certain assumptions and the results
                  may not be completely accurate. The assumptions made by the
                  tool may become outdated if government policies change. This
                  tool is not guaranteed to be perfect and its use is at your
                  own risk. We cannot be held responsible for any negative
                  consequences that may occur. To learn more about UK student
                  loans, please visit
                  <a
