...
import "../libs/assets/vendors/themify-icons/css/themify-icons.css";
import "../libs/assets/css/joeblog.css";
  ...
  render() {
    return (
      <div class="container">
          ...
          <div class="page-content">
            <div class="card">
              ...
              <div class="card-footer d-flex justify-content-between align-items-center flex-basis-0">
                ...
                <a href="#" class="text-dark small text-muted">
                  By : Joe Mitchell
                </a>
              </div>
            </div>
            ...
            <div class="page-sidebar text-center">
              ...
              <p>
                Consectetur adipisicing elit Possimus tempore facilis dolorum
                veniam impedit nobis. Quia, soluta incidunt nesciunt dolorem
                reiciendis iusto.
              </p>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body px-0">
                  ...
                  <small class="small text-muted">
                    <i class="ti-calendar pr-1"></i> January 24 2019
                  </small>
                  <p class="my-2">
                    consectetur adipisicing Cum veritatis minus iustorpo
                    cupiditate voluptas ...
                  </p>
                </div>
              </div>
              ...
              <div class="media text-left mb-4">
                ...
                <div class="media-body">
                  ...
                  <p class="text-muted small">
                    <i class="ti-calendar pr-1"></i> January 02 2019
                  </p>
                </div>
              </div>
        ...
        <script
          src={require("../libs/assets/vendors/jquery/jquery-3.4.1.js")}
        ></script>
        <script
          src={require("../libs/assets/vendors/bootstrap/bootstrap.bundle.js")}
        ></script>

        <script src={require("../libs/assets/js/joeblog.js")}></script>
      </div>
    );
  }
}
